...
Seja ![\boldsymbol{I}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_01.png) uma imagem representada como uma matriz bidimensional em que cada elemento contém a intensidade em escala de cinza de um pixel. Para um conjunto de ![n](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_02.png) pontos de interesse de ![\boldsymbol{I}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_03.png), dados por ![(x_1, y_1), (x_2, y_2), \cdots , (x_n, y_n)](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_04.png), e distribuídos ao longo dos traços faciais delimitantes, pode-se definir uma forma ![\boldsymbol{S}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_05.png) conforme a matriz abaixo. Deseja-se, pois, obter a matriz estimativa ![\boldsymbol{\hat{S}}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_06.png), de modo que os elementos de ![\boldsymbol{\hat{S}}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_07.png) se aproximem dos respectivos elementos de ![\boldsymbol{S}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_08.png) tanto quanto possível.

![\boldsymbol{S} =\begin{bmatrix}x_1 & y_1 \x_2 & y_2 \vdots & \vdots \x_n & y_n\end{bmatrix}.](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_09.png)
...
Quando a base de dados utilizada para a construção do modelo apresenta falhas na demarcação dos pontos, para cada forma do conjunto total existe uma probabilidade ![\rho](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_10.png), com ![0 \leq \rho \leq 1](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_11.png), de não se conhecer o ponto ![(x_i, y_i)](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_12.png). Nesses casos, faz-se necessário aplicar heurísticas corretivas de interpolação para preencher as lacunas existentes. Como a análise de componentes principais incorpora variações gerais da forma, em vez de posições específicas dos pontos que a constituem, métodos simples podem ser utilizados, como a interpolação linear.

Seja ![K = \langle (x_i, y_i), \cdots, (x_j, y_j) \rangle](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_13.png) uma lista contígua de pontos faltantes entre os índices ![i](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_14.png) e ![j](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_15.png), ao longo forma ![\boldsymbol{S}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_16.png), de modo que ![(x_{i - 1}, y_{i-1})](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_17.png) e ![(x_{j + 1}, y_{j + 1})](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_18.png) sejam pontos de extremidade com localizações conhecidas. É possível interpolar os valores dos pontos ![(x_k, y_k)](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_19.png), com ![i \leq k \leq j](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_20.png), por meio da equação:
...
Se todas as formas em um dado conjunto ![W = {\boldsymbol{S}_1, \boldsymbol{S}_2, \cdots, \boldsymbol{S}_k}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_22.png) representam consistentemente um mesmo objeto, então seus pontos devem seguir uma distribuição estatística no espaço bidimensional (Cootes et al. 1994). Ao se conhecer tal distribuição, obtém-se um modelo parametrizado capaz de descrever as formas do conjunto, bem como produzir novas variações com aspecto plausível e fiel ao original. A análise de componentes principais – do inglês, _principal component analysis_, ou PCA– é uma abordagem eficiente para determinar essa distribuição. Uma forma ![\boldsymbol{S}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_23.png) pode ser reconstruída a partir dos parâmetros da PCA conforme a equação a seguir.

![\boldsymbol{S} = \boldsymbol{\bar{S}} + \boldsymbol{B}\boldsymbol{p}.](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_24.png)

![\boldsymbol{\bar{S}}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_25.png) se refere à média das ![k](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_26.png) formas de ![W](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_27.png), ![\boldsymbol{B}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_28.png) é uma matriz composta pelos ![t](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_29.png) primeiros autovetores da matriz de covariância das formas e ![\boldsymbol{p}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_30.png) contém ![t](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_31.png) parâmetros de deformação. Ao aplicar-se variações nos elementos do vetor ![\boldsymbol{p}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_32.png), é possível produzir formas que não existiam no conjunto original.

Antes do cálculo do modelo é preciso normalizar as formas de ![W](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_33.png). Para normalizar uma forma ![\boldsymbol{S}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_34.png), com ![n](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_35.png) pontos ![(x_i, y_i)](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_36.png), efetua-se a translação, escalonamento e rotação de ![\boldsymbol{S}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_37.png) pelos respectivos fatores ![\boldsymbol{\tau}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_38.png), ![\lambda](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_39.png) e ![\theta](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_40.png) descritos a seguir (Kendall 1989). Os termos ![(z_i, w_i)](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_41.png) são pontos de ![\boldsymbol{S_1}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_42.png), após sua normalização por ![\boldsymbol{\tau}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_43.png) e ![\lambda](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_44.png).
...
Para aplicar as árvores de regressão, é preciso definir, a princípio, uma estimativa inicial para ![\boldsymbol{S}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_48.png). A forma média ![\boldsymbol{\bar{S}}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_49.png) serve bem a essa finalidade, porque permite alcançar, já de início, maior proximidade com o resultado final do que uma estimativa aleatória, por exemplo. No segundo termo, a matriz ![\boldsymbol{B}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_50.png) provém do cálculo da análise de componentes principais e o vetor de parâmetros ![\boldsymbol{p}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_51.png) deverá ser fornecido pela cadeia de regressores. A forma média é, então, posicionada na região central da face, detectada com o auxílio do método de histograma de gradientes orientados (Dalal and Triggs 2005).

Após o cálculo da estimativa inicial, tanto ![\boldsymbol{\hat{S}}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_52.png) quanto ![\boldsymbol{S}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_53.png) são normalizadas pelos fatores ![\tau](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_54.png), ![\lambda](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_55.png) e ![\theta](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_56.png). Assim, é possível aplicar sobre elas a análise de componentes principais, para calcular os parâmetros ![\boldsymbol{\hat{p}}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_57.png) e ![\boldsymbol{p}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_58.png). Logo, a mudança necessária sobre ![\boldsymbol{\hat{p}}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_59.png) para obter ![\boldsymbol{p}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_60.png), _i_._e_., o resíduo da estimativa inicial, é dada por ![\Delta \boldsymbol{p} = \boldsymbol{p} - \boldsymbol{\hat{p}}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_61.png). Deseja-se, pois, que as árvores de regressão sejam capazes de fornecer um ajuste aproximado ![\Delta \boldsymbol{\hat{p}}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_62.png) para diminuir o resíduo tanto quanto possível.

### Processamento das amostras

Estruturalmente, as árvores de regressão são árvores binárias nas quais os nós internos dividem o conjunto de amostras com base em critérios específicos aplicados sobre os dados de treino. Nós de um mesmo nível aplicam o mesmo critério. Para incorporar a informação dos pixels da imagem ![\boldsymbol{I}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_63.png) no processo de treino, um conjunto ![M = {\boldsymbol{m}_1, \boldsymbol{m}_2, \cdots, \boldsymbol{m}_q}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_64.png) de pontos de referência aleatórios da região da face é associado a cada regressor. A partir deles, os critérios de divisão das árvores são definidos como tuplas ![\mu = (\boldsymbol{m}_i, \boldsymbol{m}_j, \alpha)](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_65.png), com ![1 \leq i,j \leq q](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_66.png) e ![i \neq j](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_67.png). O valor ![\alpha](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_68.png) é um fator limiar de diferença entre as intensidades dos pixels em ![\boldsymbol{m}_i](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_69.png) e ![\boldsymbol{m}_j](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_70.png). Tanto ![\alpha](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_71.png) quanto o primeiro ponto, ![\boldsymbol{m}_i](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_72.png), são sorteados aleatoriamente com distribuição de probabilidade uniforme. Entretanto, para a escolha de ![\boldsymbol{m}_j](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_73.png), são favorecidos pontos com distância euclideana mais próxima de ![\boldsymbol{m}_i](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_74.png).

Portanto, em cada nó ![\beta](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_75.png) da árvore, para cada imagem dos dados de treino, se a intensidade do pixel de coordenada ![\boldsymbol{m_i}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_76.png) subtraída da intensidade do pixel de coordenada ![\boldsymbol{m_j}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_77.png) superar o limiar ![\alpha](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_78.png), a imagem é encaminhada para a subárvore direita ![\beta_\text{dir}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_79.png). Caso contrário, é encaminhada à subárvore esquerda ![\beta_\text{esq}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_80.png). Ao fim das sucessivas divisões, a predição final ![\Delta \boldsymbol{\hat{p}}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_81.png) da árvore é determinada pela média dos vetores ![\Delta \boldsymbol{p}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_82.png) das amostras remanescentes em cada folha.

A predição de uma árvore pode ser melhorada significativamente se os critérios de divisão para cada nível forem escolhidos dentre os melhores de um conjunto ![C = {\mu_1, \mu_2, \cdots, \mu_c}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_83.png), gerado de forma randômica. Um critério pode ser avaliado quanto à sua qualidade pela função ![f: C \to \mathbb{R}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_84.png), definida conforme a equação abaixo, na qual ![\beta_{\mu, \text{dir}}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_85.png) e ![\beta_{\mu, \text{esq}}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_86.png) referem-se ao conjunto de imagens que foram encaminhadas para a subárvore direita e esquerda pelo critério ![\mu](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_87.png).

![f(\mu) = \left\lVert\beta_{\mu, \text{dir}}\right\rVert  \sum_{\forall , \Delta \boldsymbol{p}, \in , \beta_{\mu, \text{dir}}} \Delta \boldsymbol{p} + \left\lVert\beta_{\mu, \text{esq}}\right\rVert   \sum_{\forall , \Delta \boldsymbol{p} , \in , \beta_{\mu, \text{esq}}} \Delta \boldsymbol{p}.](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_88.png)

### Treino e predição

No processo de treino, cada árvore recebe uma lista de tuplas dada por ![D = \langle(\boldsymbol{I}_1, \boldsymbol{p}_1, \boldsymbol{\hat{p}}_1, \Delta\boldsymbol{p}, M_1), \cdots, (\boldsymbol{I}_k, \boldsymbol{p}_k, \boldsymbol{\hat{p}}_k, \Delta\boldsymbol{p}, M_k) \rangle](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_89.png), cujos termos correspondem a cada uma das ![k](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_90.png) amostras de imagens com formas ![\boldsymbol{S}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_91.png) demarcadas. Uma vez que o treinamento de uma árvore é concluído, o processo para efetuar a predição de uma nova amostra consiste em aplicar os critérios ![\mu](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_92.png) à imagem em cada nível até que se atinja um nó folha. Em seguida, a predição ![\Delta \boldsymbol{\hat{p}}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_93.png) que foi associada ao nó durante a aprendizagem é multiplicada a um fator de amortecimento ![\phi](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_94.png), e somada aos parâmetros ![\boldsymbol p](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_95.png) da amostra correspondente, de modo a obter um novo vetor de parâmetros atualizado ![\boldsymbol{p}'](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_96.png). Pode-se, então atualizar a forma da estimativa ![\boldsymbol{\hat{S}}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_97.png).

Após a aplicação de sucessivas árvores de regressão, a estimativa ![\boldsymbol{\hat{S}}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_98.png) deve convergir para uma configuração que, embora mais próxima de ![\boldsymbol{S}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_99.png) do que a princípio, ainda requer ajustes. Faz-se necessário, portanto, atualizar o conjunto de pontos de referência ![M](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_100.png) das futuras árvores, para que reflitam a mudança de aspecto de ![\boldsymbol{\hat{S}}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_101.png) e uma nova cadeia de ajustes possa ocorrer. Seja ![\boldsymbol{\hat{S}}'](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_102.png) a forma ![\boldsymbol{\hat{S}}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_103.png) antes do ajuste pelas árvores. Para que sejam reposicionados, os pontos ![\boldsymbol{m}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_104.png) são rotacionados por um ângulo ![\gamma](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_105.png) em torno do ponto mais próximo de ![\boldsymbol{\hat{S}}'](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_106.png) com o raio da rotação escalonado conforme um fator de escalonamento ![\psi](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_107.png). Os fatores ![\gamma](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_108.png) e ![\psi](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_109.png) são, respectivamente, a rotação e escala que transformam ![\boldsymbol{\hat{S}}'](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_110.png) em ![\boldsymbol{\hat{S}}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_111.png)  (Kazemi and Sullivan 2014).

### Avaliação da estimativa

Para averiguar o grau de aproximação entre a predição e a forma real, o erro é calculado como a média das distâncias euclideanas entre os pontos de ![\boldsymbol{S}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_112.png) e seus correspondentes em ![\boldsymbol{\hat{S}}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_113.png), como descrito na equação abaixo. Para mitigar diferenças de resolução das imagens das amostras, as distâncias são normalizadas pela distância interocular ![d](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_114.png), calculada a partir da diferença entre os pontos médios dos trechos correspondentes aos olhos em ![\boldsymbol{S}](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_115.png) (Zhu and Ramanan 2012).

![E(\boldsymbol{S}, \boldsymbol{\hat{S}}) = \frac{1}{n}{\sum_{i = 1}^{n}\frac{\sqrt{(x_i - \hat{x}_i)^2 + (y_i - \hat{y}_i)^2}}{d}}.](https://s3.amazonaws.com/abnersn/github/facial-landmarks/equations/eq_116.png)
